...
SECRET_KEY = ')&%@(n0r#3-@3)&(qltki*ggj-#!n^a^t0l^03_nkmb-7@3w2$'
...
ALLOWED_HOSTS = ['.vercel.app', '.now.sh', '127.0.0.1', 'localhost', 'mwakazieric.tech']
...
DATABASES = {
    ...
    'default': {
        ...
        # 'NAME': os.getenv('uumkclxo'),
        # 'USER': os.getenv('uumkclxo'),
        # 'PASSWORD': os.getenv('q3g1vCa_SPAt4Rzy2s71qr8rCWS2qJ27'),
        # 'HOST': os.getenv('kala.db.elephantsql.com'),
        # 'PORT': '6625',
